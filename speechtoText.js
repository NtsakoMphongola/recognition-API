    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.box} >
                ...
                <Button title='Stop' onPress={SpeechRecognition.stopListening} color='red' ></Button>
                <Button title='Reset' onPress={resetTranscript} color='gray'></Button>
                {/* <p>{transcript}</p> */}
            </View>
